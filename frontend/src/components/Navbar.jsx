				...
				<div className='flex flex-wrap justify-between items-center'>
					...
					<nav className='flex flex-wrap items-center gap-4'>
						{user && (
							<Link
								to={"/cart"}
								className='relative group text-white hover:text-emerald-400 transition duration-300 
							ease-in-out'
							>
						...
						{isAdmin && (
							<Link
								className='bg-black hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium
						...
						{user ? (
							<button
								className='bg-black hover:bg-emerald-600 text-white py-2 px-4 
